...
def parse_args():
  ...
  parser.add_argument('--image_dir', type=str, default='./results/manip_sample',
  ...
  parser.add_argument('--boundary_path', type=str, default='./boundaries/stylegan_ffhq256/expression.npy',
                      help='Path to the boundary for semantic manipulation.')
  parser.add_argument('-o', '--output_dir', type=str, default='./results/manip_sample/manip2',
