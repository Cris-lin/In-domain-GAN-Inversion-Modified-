...
def parse_args():
  ...
  parser.add_argument('--loss_weight_feat', type=float, default=1,
                      help='The perceptual loss scale for optimization. '
                           '(default: 5e-5)')
  parser.add_argument('--loss_weight_enc', type=float, default=0,
...
def main():
  ...
  output_dir = args.output_dir or f'results/inversion_500_modi_2/{image_list_name}'
